...
pygame.font.init()
font = pygame.font.Font(r'../assets/icons/CaslonAntique.ttf', 28)


class FightStaus:

    def __init__(self):
        self.background = pygame.image.load('../assets/icons/fight_sit.png').convert()
    ...
    def show(self, player, enemy0):
        ...
        self.surface.blit(font.render(player.name, True, 'White'),
                          (self.rectp.left + 15, self.rectp.top + 15))
        self.surface.blit(
            font.render(str(math.ceil(player.current_HP)), True, 'White'),
            (self.rectp.left + 60, self.rectp.top + 50))
        self.surface.blit(
            font.render(str(math.ceil(player.atk)), True, 'White'),
            (self.rectp.left + 120, self.rectp.top + 50))
        self.surface.blit(
            font.render(str(math.ceil(player.defe)), True, 'White'),
            (self.rectp.left + 180, self.rectp.top + 50))
        self.surface.blit(font.render(enemy0.name, True, 'White'),
                          (self.recte.left + 15, self.recte.top + 15))
        self.surface.blit(
            font.render(str(math.ceil(enemy0.current_HP)), True, 'White'),
            (self.recte.left + 60, self.recte.top + 50))
        self.surface.blit(
            font.render(str(math.ceil(enemy0.atk)), True, 'White'),
            (self.recte.left + 120, self.recte.top + 50))
        self.surface.blit(
            font.render(str(math.ceil(enemy0.defe)), True, 'White'),
...
class FightingScene:
    ...
    def __init__(self, Player, Monster: enemy):
        self.Player = Player
        self.Monster = Monster
        self.discard_pile = Pile()
        self.status = pygame.image.load('../assets/icons/fight_sit.png').convert()
    ...
    def show_status(self, surface):
        ...
        surface.blit(font.render(self.Player.name, True, 'White'),
                     (self.rectp.left + 15, self.rectp.top + 15))
        surface.blit(
            font.render(str(math.ceil(self.Player.current_HP)), True, 'White'),
            (self.rectp.left + 60, self.rectp.top + 50))
        surface.blit(
            font.render(str(math.ceil(self.Player.atk)), True, 'White'),
            (self.rectp.left + 120, self.rectp.top + 50))
        surface.blit(
            font.render(str(math.ceil(self.Player.defe)), True, 'White'),
            (self.rectp.left + 180, self.rectp.top + 50))
        surface.blit(font.render(self.Monster.name, True, 'White'),
                     (self.recte.left + 15, self.recte.top + 15))
        surface.blit(
            font.render(str(math.ceil(self.Monster.current_HP)), True,
                        'White'), (self.recte.left + 60, self.recte.top + 50))
        surface.blit(
            font.render(str(math.ceil(self.Monster.atk)), True, 'White'),
            (self.recte.left + 120, self.recte.top + 50))
        surface.blit(
            font.render(str(math.ceil(self.Monster.defe)), True, 'White'),
            (self.recte.left + 180, self.recte.top + 50))
    ...
    def load_background(self, surface):
        background = pygame.image.load(
            r'../assets/background/stage_fight.jpg').convert()
        surface.blit(background, (0, 0))

        enemySurf = pygame.transform.scale(
            pygame.image.load(self.Monster.icon).convert(), (300, 300))
        ...
        playerSurf = pygame.transform.scale(
            pygame.image.load(r'../assets/character/Player.png').convert(),
            (300, 300))
        ...
        HPofMonster = pygame.Surface(
            (80 * (max(self.Monster.current_HP, 0) / self.Monster.total_HP),
             15))
        ...
        HPofPlayer = pygame.Surface(
            (80 * (max(self.Player.current_HP, 0) / self.Player.total_HP), 15))
        HPofPlayer.fill((255, 0, 0))
        HPofPlayerRect = HPofPlayer.get_rect(topleft=(930, 420))
        surface.blit(HPofPlayer, HPofPlayerRect)

        DeckImage = pygame.image.load(r'../assets/cards/back.png').convert()
        DeckImage = pygame.transform.rotozoom(DeckImage, 0, 2 / 3)
        Deckplayerimage = pygame.Surface(
            (DeckImage.get_width(), DeckImage.get_height()))
...
class EndTurnButton:
    ...
    def __init__(self, posX, posY):
        self.image = pygame.image.load(r'../assets/icons/button.png').convert()
        self.function = font.render('End Turn', True, 'Red')
        self.rect = self.image.get_rect()
        self.image.blit(self.function,
                        self.function.get_rect(center=self.rect.center))
        self.rect.x = posX
        self.rect.y = posY
